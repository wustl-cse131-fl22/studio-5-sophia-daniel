...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		StdDraw.setPenColor(225,255,109);
	...
	/** 
	* return is the mean from an array of ints 
	*
	*/
	
	public static double arrayMean (int[]number) {
		double mean = (double)arraySum(number)/(number.length);
		return mean;
	}
